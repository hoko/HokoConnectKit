...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) HokoConnectKit * _Nonnull sharedInstance;)
+ (HokoConnectKit * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
/// Identify the user that is using your app with a unique Id like an email address or code. This Id
/// is passed along to other apps through deep links for later attribution. By default we use
/// the device unique Id to identify the user. When that fails we use a random code.
