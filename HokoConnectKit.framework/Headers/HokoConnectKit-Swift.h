...
/// Get a specific advertiser by code.
/// <ul>
///   <li>
///     advertiserCode: Code of the advertiser to retrieve
///   </li>
/// </ul>
/// \param completionCallback Callback called when the request is completed.
///
/// \param failureCallback Callback called when the request has failed.
///
- (void)getAdvertiser:(NSString * _Nonnull)advertiserCode completionCallback:(void (^ _Nonnull)(Advertiser * _Nonnull))completionCallback failureCallback:(void (^ _Nullable)(NSString * _Nullable))failureCallback;
@end
